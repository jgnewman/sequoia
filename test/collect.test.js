...
describe('Queriable Arrays', function () {
  ...
  it('should update the items matching a query', function () {
    ...
    assert.equal(collect(updated).getAllWhere({firstName: 'Patrick'}).length, 2);
  })
  ...
  it('should update all the items', function () {
    ...
    assert.equal(collect(updated).getAllWhere({firstName: 'Patrick'}).length, 3);
  })
  ...
  it('should update the first item matching a query', function () {
    ...
    assert.equal(collect(updated).getAllWhere({firstName: 'Patrick'}).length, 1);
  })
